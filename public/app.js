...
},{"./lib/core.js":2,"./locale-data/complete.js":29}],2:[function(require,module,exports){
(function (global){
'use strict';
...
},{"global/document":32,"hyperx":35,"on-load":59}],29:[function(require,module,exports){
...
},{"min-document":29}],33:[function(require,module,exports){
(function (global){
var win;
...
},{"./lib/locales":29,"./lib/main":43}],39:[function(require,module,exports){
/*
...
},{"./compiler":39,"./es5":42,"./utils":44,"intl-messageformat-parser":36}],41:[function(require,module,exports){
// GENERATED FILE
"use strict";
...
},{"./core":40,"./en":41}],44:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./lib/locales":29,"./lib/main":52}],48:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./diff":49,"./es5":51,"intl-messageformat":38}],49:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./core":48,"./en":50,"dup":43}],53:[function(require,module,exports){
...
},{"assert":58,"global/document":32,"global/window":33}],60:[function(require,module,exports){
(function (process){
...
},{"./is-object":64,"./request-base":65,"./response-base":66,"./should-retry":67,"component-emitter":30}],64:[function(require,module,exports){
/**
...
},{"./update-events.js":71,"bel":28,"morphdom":57}],71:[function(require,module,exports){
module.exports = [
...
var el = yo`<footer class="site-footer">
  <div class="container">
    <div class="row">
      <div class="col s12 l3 center-aling"><a href="#" data-activates="dropdown1" class="dropdown-button btn btn-flat">${translate.message('language')}</a>
        <ul id="dropdown1" class="dropdown-content">
          <li><a href="#" onclick=${lang.bind(null, 'es')} >${translate.message('spanish')}</a></li>
          <li><a href="#" onclick=${lang.bind(null, 'en-US')} >${translate.message('english')}</a></li>
        </ul>
      </div>
      <div class="col s12 l3 push-l6 center-aling">© 2017 Platzigram</div>
    </div>
  </div>
</footer>`;
...
},{"../translate":85,"yo-yo":70}],73:[function(require,module,exports){
...
},{"./template":74,"axios":3,"empty-element":31,"page":60,"superagent":63,"title":69}],74:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"../layout":77,"../picture-card":78,"../translate":85,"yo-yo":70}],75:[function(require,module,exports){
var page = require('page');
...
},{"./footer":72,"./homepage":73,"./signin":79,"./signup":81,"page":60}],76:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"yo-yo":70}],77:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"../translate":85,"yo-yo":70}],79:[function(require,module,exports){
var page = require('page');
var emty = require('empty-element');
var template = require('./template');
var title = require('title');
...
},{"./template":80,"empty-element":31,"page":60,"title":69}],80:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"../landing":76,"../translate":85,"yo-yo":70}],81:[function(require,module,exports){
var page = require('page');
var emty = require('empty-element');
var template = require('./template');
var title = require('title');
...
},{"./template":82,"empty-element":31,"page":60,"title":69}],82:[function(require,module,exports){
var yo = require('yo-yo');
                        ...
                        <div class="row">
                            <div class="signup-box">
                                ...
                                <form action="#" class="signup-form">
                                    ...
                                    <div class="section">
                                        <a class="btn btn-fb hide-on-small-only">${translate.message('signup.facebook')}</a>
                                        <a class="btn btn-fb hide-on-med-and-up"><i class="fa fa-facebook-offcicial"></i>${translate.message('signup.text')}</a>
                                    </div>
                                    <div class="devaiser"></div>
                                    <div class="section">
...
},{"../landing":76,"../translate":85,"yo-yo":70}],83:[function(require,module,exports){
module.exports = {
											likes: ' {likes , plural, ' + '=0 {no likes}' + '=1 {# like }' + 'other { # likes}}',
											'logout': 'Logout',
											'english': 'English',
											'spanish': 'Spanish',
											'signup.subheading': 'Signup to watch your friends\' pictures studying at Platzigram',
...
module.exports = {
	...
	'english': 'Inglès',
	'spanish': 'Español',
	'signup.subheading': 'Registrate para ver fotos de tus amigos estudiando en platzigram',
	'signup.facebook': 'Iniciar Sesiòn con Facebook',
	'signup.text': 'Iniciar Sesiòn',
	'email': 'Correo electrònico',
	'username': 'Nombre de usuario',
	'fullname': 'Nombre completo',
	'password': 'Contraseña',
	'signup.call-to-action': 'Regìstrate',
...
},{"./en-US":83,"./es":84,"Intl":1,"intl-messageformat":38,"intl-relativeformat":47,"intl-relativeformat/dist/locale-data/en.js":45,"intl-relativeformat/dist/locale-data/es.js":46,"intl/locale-data/jsonp/en-US.js":53,"intl/locale-data/jsonp/es.js":54}]},{},[75]);
